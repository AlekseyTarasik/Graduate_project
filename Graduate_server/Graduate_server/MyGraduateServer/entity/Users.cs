...
namespace Graduate_server.MyGraduateServer.entity
{
    class Users
    {
        ...
        public static string VerificationUsers(string login, string pass)
        {
            ...
            string sql = "SELECT * FROM User_data WHERE login_user ='" + login + "', pass_user ='" + pass + "'";
            ...
            try
            {
                ...
                using (DbDataReader reader = cmd.ExecuteReader())
                {
                    if (reader.HasRows)
                    {
                        ...
                        {
                            Console.WriteLine(reader.GetInt32(9));
                            message.Append(reader.GetString(3));
                            message.Append(successful_auth + Delimiter + reader.GetString(3));
                        }
